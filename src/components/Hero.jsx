          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-600">
                A project by Open Avenues completed by Elvis Moran
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="https://github.com/ElvisFMM/Traffic-simulation-demo">View SUMO config files on GitHub</Button>
              </div>
            </div>
          </div>
